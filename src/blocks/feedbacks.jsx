...
export default function Feedbacks() {
   ...
   const feedbacksData = [
   {
      ...
      description:
         "Работа с этим разработчиком была великолепной! Учел все мои пожелания, предложил несколько отличных идей, которых я бы не придумал. Сайт получился современным и удобным. Очень доволен результатом!",
   },
   {
      rating: "4.8",
      name: "Мария П.",
